...
export const VirtualRoom = () => {
  ...
  const participants = [
    ...
    { id: 2, name: "Alex Chen", avatar: "", isHost: false, video: true, audio: true },
    { id: 3, name: "Sarah Johnson", avatar: "", isHost: false, video: false, audio: true },
    { id: 4, name: "Mike Rodriguez", avatar: "", isHost: false, video: true, audio: false }
  ];

  const chatMessages = [
    { id: 1, sender: "Alex Chen", message: "Hey everyone! Ready to tackle these calculus problems?", time: "2:30 PM" },
    { id: 2, sender: "Sarah Johnson", message: "Absolutely! I have some questions about integration by parts.", time: "2:31 PM" },
    { id: 3, sender: "Mike Rodriguez", message: "Same here. Let's start with the practice problems.", time: "2:32 PM" }
  ];
          ...
          <div className="flex-1 flex">
            ...
            <div className="flex-1 flex flex-col bg-white dark:bg-gray-900 border-r">
              ...
              <div className="border-b bg-card/80 backdrop-blur-sm p-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium text-muted-foreground mr-3">Tools:</span>
              ...
              <div className="flex-1 bg-white dark:bg-gray-950 flex items-center justify-center relative">
                <div className="text-center text-muted-foreground">
                  ...
                  <p className="text-sm">Click and drag to draw • Use tools above</p>
                </div>
